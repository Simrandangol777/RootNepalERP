...
const ProductDetailModal = ({ product, onClose, onEdit }) => {
  ...
  return (
    <div className="product-detail-modal fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="product-detail-shell bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden border border-white/20 shadow-2xl">
        {/* Header */}
        <div className="product-detail-header bg-white/10 backdrop-blur-xl border-b border-white/20 px-6 py-4 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-white">Product Details</h2>
          <button
            onClick={onClose}
            className="product-detail-close p-2 text-white/70 hover:text-white hover:bg-white/10 rounded-lg transition-all"
          >
        ...
        {/* Content */}
        <div className="product-detail-body overflow-y-auto" style={{ maxHeight: 'calc(90vh - 140px)' }}>
          <div className="p-6">
            {/* Product Image and Basic Info */}
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              {/* Image */}
              <div className="md:col-span-1">
                <div className="product-detail-image aspect-square rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden">
                  {product.image ? (
              ...
              <div className="md:col-span-2 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="product-detail-stat bg-white/5 border border-white/10 rounded-xl p-4">
                  ...
                  <div className="product-detail-stat product-detail-stat--price bg-white/5 border border-white/10 rounded-xl p-4">
                  ...
                  <div className="product-detail-stat product-detail-stat--cost bg-white/5 border border-white/10 rounded-xl p-4">
            ...
            {/* Tabs */}
            <div className="product-detail-panel bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
              {/* Tab Headers */}
              <div className="product-detail-tab-list flex border-b border-white/10 bg-white/5">
                <button
                  onClick={() => setActiveTab('details')}
                  className={`product-detail-tab ${activeTab === 'details' ? 'is-active' : ''} flex-1 px-6 py-3 text-sm font-semibold transition-all ${
                    activeTab === 'details'
                ...
                <button
                  ...
                  className={`product-detail-tab ${activeTab === 'inventory' ? 'is-active' : ''} flex-1 px-6 py-3 text-sm font-semibold transition-all ${
                    activeTab === 'inventory'
                      ? 'bg-gradient-to-r from-purple-600 to-blue-600 text-white'
                      : 'text-white/70 hover:text-white hover:bg-white/5'
                  }`}
                ...
                <button
                  ...
                  className={`product-detail-tab ${activeTab === 'supplier' ? 'is-active' : ''} flex-1 px-6 py-3 text-sm font-semibold transition-all ${
                    activeTab === 'supplier'
                      ? 'bg-gradient-to-r from-purple-600 to-blue-600 text-white'
                      : 'text-white/70 hover:text-white hover:bg-white/5'
                  }`}
              ...
              <div className="p-6">
                ...
                {activeTab === 'inventory' && (
                  <div className="space-y-4">
                    ...
                    {/* Stock Alert */}
                    {product.stock <= product.reorderLevel && (
                      <div className="product-detail-alert bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 flex items-start gap-3">
        ...
        {/* Footer */}
        <div className="product-detail-footer bg-white/10 backdrop-blur-xl border-t border-white/20 px-6 py-4 flex items-center justify-end gap-3">
          <button
            onClick={onClose}
            className="product-detail-secondary px-6 py-3 bg-white/5 hover:bg-white/10 text-white rounded-xl transition-all"
          >
            Close
          </button>
          <button
            onClick={onEdit}
            className="product-detail-primary group relative px-6 py-3"
          >
